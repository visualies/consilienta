  ...
  return (
    <>
      ...
      <Dialog open={!!selectedSolution} onOpenChange={() => setSelectedSolution(null)}>
        <DialogContent className="!max-w-[90vw] w-[90vw] max-h-[80vh] overflow-y-auto lg:!max-w-[60vw] lg:w-[60vw] bg-white [&_button]:text-gray-600 [&_button]:hover:text-gray-900">
